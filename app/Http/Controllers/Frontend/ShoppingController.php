...
class ShoppingController extends Controller
{
    ...
    public function addTocartGet($id,Request $request){
        ...
        $productInfo = Product::with('image','images', 'activeCampaign')->findOrFail($id);
        ...
        $cartinfo = Cart::instance('shopping')->add([
            ...
            'options' => [
                ...
                'purchase_price' => $productInfo->purchase_price,
                 'campaign_price' => optional($productInfo->activeCampaign->first())->pivot->campaign_price ?? null,
            ]
        ]);
    ...
    public function cart_store(Request $request)
    {
        ...
        Cart::instance('shopping')->add([
            ...
            'options' => [
                ...
                'campaign_price' => optional($product->activeCampaign->first())->pivot->campaign_price ?? null,
            ],
        ]);
