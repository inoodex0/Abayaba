...
use App\Http\Controllers\Admin\NewCampaignController;
...
Route::group(['namespace'=>'Frontend', 'middleware' => ['ipcheck','check_refer']], function() {
    ...
    Route::get('brand/{brand}', [FrontendController::class, 'brand'])->name('brand');
    ...
    // header cart
    Route::get('/cart/count/header', [ShoppingController::class, 'cartCount'])->name('cart.count.header');
    ...
    Route::get('/campaing/{id}', [FrontendCampaignController::class, 'index'])->name('campaing.index');
...
Route::group(['namespace'=>'Admin','middleware' => ['auth','lock','check_refer'],'prefix'=>'admin'], function() {
    ...
    Route::post('orderstatus/destroy', [OrderStatusController::class,'destroy'])->name('orderstatus.destroy');
     ...
     // slider notice
     Route::get('slidingnotice/manage', [SlidingNoticeController::class,'index'])->name('slidingnotice.index');
     Route::get('slidingnotice/{id}/show', [SlidingNoticeController::class,'show'])->name('slidingnotice.show');
     Route::get('slidingnotice/create', [SlidingNoticeController::class,'create'])->name('slidingnotice.create');
     Route::post('slidingnotice/save', [SlidingNoticeController::class,'store'])->name('slidingnotice.store');
     Route::get('slidingnotice/{id}/edit', [SlidingNoticeController::class,'edit'])->name('slidingnotice.edit');
     Route::post('slidingnotice/update', [SlidingNoticeController::class,'update'])->name('slidingnotice.update');
     Route::post('slidingnotice/inactive', [SlidingNoticeController::class,'inactive'])->name('slidingnotice.inactive');
     Route::post('slidingnotice/active', [SlidingNoticeController::class,'active'])->name('slidingnotice.active');
     Route::post('slidingnotice/destroy', [SlidingNoticeController::class,'destroy'])->name('slidingnotice.destroy');


      // Media Library
     Route::get('media_library/manage', [MediaLibraryController::class,'index'])->name('media_library.index');
    //  Route::get('slidingnotice/{id}/show', [SlidingNoticeController::class,'show'])->name('slidingnotice.show');
    //  Route::get('slidingnotice/create', [SlidingNoticeController::class,'create'])->name('slidingnotice.create');
    //  Route::post('slidingnotice/save', [SlidingNoticeController::class,'store'])->name('slidingnotice.store');
    //  Route::get('slidingnotice/{id}/edit', [SlidingNoticeController::class,'edit'])->name('slidingnotice.edit');
    ...
    //  Route::post('slidingnotice/inactive', [SlidingNoticeController::class,'inactive'])->name('slidingnotice.inactive');
    //  Route::post('slidingnotice/active', [SlidingNoticeController::class,'active'])->name('slidingnotice.active');
     Route::post('media_library/destroy', [MediaLibraryController::class,'destroy'])->name('media_library.destroy');
    ...
    Route::post('products/soft/delete', [ProductController::class,'softDelete'])->name('products.soft_delete');
    ...
    Route::get('products/inactive-products', [ProductController::class,'inactiveProducts'])->name('products.inactive.products');
    Route::get('products/stock-out-products', [ProductController::class,'stockOutProducts'])->name('products.stock.out.products');
    Route::get('products/retrieve', [ProductController::class,'retrieve'])->name('products.retrieve');
    ...
    Route::post('order/soft-delete', [OrderController::class,'softDelete'])->name('admin.order.soft_delete');
    ...
    Route::post('order-bulk-destroy', [OrderController::class,'bulk_destroy'])->name('admin.order.bulk_destroy');
    Route::post('order-bulk-soft-delete', [OrderController::class,'bulk_soft_delete'])->name('admin.order.bulk_soft_delete');
...
Route::group(['middleware' => ['auth','lock','check_refer'],'prefix'=>'admin', ], function() {
    Route::post('new-campaign/inactive', [NewCampaignController::class,'inactive'])->name('new.campaign.inactive');
    Route::post('new-campaign/active', [NewCampaignController::class,'active'])->name('new.campaign.active');
    // Routes for adding and removing products
    Route::post('new-campaign/{campaignId}/add-product', [NewCampaignController::class, 'addProductToCampaign'])->name('new-campaign.add-product');
    Route::delete('new-campaign/{campaignId}/remove-product/{productId}', [NewCampaignController::class, 'removeProductFromCampaign'])->name('new-campaign.remove-product');
    Route::get('/get-product-prices/{id}', [NewCampaignController::class, 'getPrices'])->name('new-campaign.get-prices');
    Route::put('new_campaign/change_status', [NewCampaignController::class, 'updateStatus'])->name('new_campaign.change_status');
    Route::resource('new-campaign', NewCampaignController::class); 
    
    
    /** blog category */
    Route::put('blog-category/change_status', [BlogCategoryController::class, 'changeStatus'])->name('blog_category.change_status');
    Route::resource('blog-category', BlogCategoryController::class);

    /** blog */
      Route::put('blog/change_status', [BlogController::class, 'changeStatus'])->name('blog.change_status');
