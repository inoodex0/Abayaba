...
<body>
  ...
  <section
    style="background: url('{{asset($campaign_data->image_one)}}'); background-repeat: no-repeat; background-size:cover; background-position: center;">
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
  ...
  <section class="camp_video_sec">
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          <div class="camp_vid">
            <iframe width="853" height="480" src="https://www.youtube.com/embed/{{$campaign_data->youtube_video}}"
              title="{{$campaign_data->name}}" frameborder="0"
                          ...
                          <div class="row">
                            <div class="col-sm-12">
                              <div class="form-group mb-3">
                                ...
                                <input type="text" id="name" class="form-control @error('name') is-invalid @enderror"
                                  name="name" value="{{old('name')}}" placeholder="নাম" required>
                                @error('name')
                            ...
                            <div class="col-sm-12">
                              <div class="form-group mb-3">
                                ...
                                <input type="number" minlength="11" id="number" maxlength="11" pattern="0[0-9]+"
                            ...
                            <div class="col-sm-12">
                              <div class="form-group mb-3">
                                ...
                                <input type="address" id="address"
                                  ...
                                  placeholder="জেলা, থানা, গ্রাম " name="address" value="{{old('address')}}" required>
                                @error('email')
                                <span class="invalid-feedback" role="alert">
                                  <strong>{{ $message }}</strong>
                                </span>
