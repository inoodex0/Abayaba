...
<html lang="en">
  ...
  <body data-layout-mode="default" data-theme="light" data-layout-width="fluid" data-topbar-color="dark" data-menu-position="fixed" data-leftbar-color="light" data-leftbar-size="default" data-sidebar-user="false">
            ...
            <ul id="side-menu">
                ...
                <div class="collapse" id="siebar-product">
                  <ul class="nav-second-level">
                    ...
                    <li>
                     ...
                     <li>
                      <a href="{{route('products.inactive.products')}}"><i data-feather="file-plus"></i>InActive Products</a>
                    </li>
                    <li>
                      <a href="{{route('products.stock.out.products')}}"><i data-feather="file-plus"></i>Stock Out Products</a>
                    </li>
                    <li>
                      <a href="{{route('products.trash')}}"><i data-feather="file-plus"></i>Trash</a>
                    </li>
              ...
              <li class="">
                ...
                <div class="collapse" id="sidebar-landing-page">
                  <ul class="nav-second-level">                   
                    ...
                    <li>
                      <a href="{{route('campaign.index')}}"><i data-feather="file-plus"></i> Landing List</a>
                    </li>
                  </ul>
                </div>
              </li>
              <li class="">
                <a href="#sidebar-campaign-page" data-bs-toggle="collapse">
                  <i data-feather="airplay"></i>
                  <span> Campaign Page </span>
                  <span class="menu-arrow"></span>
                </a>
                <div class="collapse" id="sidebar-campaign-page">
                  <ul class="nav-second-level">                   
                    
                    <li>
                      <a href="{{route('new-campaign.create')}}"><i data-feather="file-plus"></i> Create</a>
                    </li>
                    <li>
                      <a href="{{route('new-campaign.index')}}"><i data-feather="file-plus"></i> Campaign</a>
                    </li>
                  </ul>
                </div>
              </li>
              ...
              <li>
                ...
                <div class="collapse" id="siebar-sitesetting">
                  <ul class="nav-second-level">
                    ...
                    <li>
                      <a href="{{route('slidingnotice.index')}}"><i data-feather="file-plus"></i>Sliding Notice</a>
                    </li>
                    <li>
                      <a href="{{route('media_library.index')}}"><i data-feather="file-plus"></i>Media Library</a>
                    </li>
                  </ul>
                </div>
              </li>
              ...
              <li>
                ...
                <div class="collapse" id="siebar-blog">
                  <ul class="nav-second-level">
                    <li>
                      <a href="{{route('blog-category.index')}}"><i data-feather="file-plus"></i>Category</a>
                    </li>
                    <li>
                      <a href="{{route('blog.index')}}"><i data-feather="file-plus"></i> Blogs</a>
                    </li>
                  </ul>
                </div>
              </li>
    ...
    <script type="text/javascript">
      $(".soft-delete").click(function (event) {
        var form = $(this).closest("form");
        event.preventDefault();
        swal({
          title: `Are you sure you want to delete this record?`,
          text: "Deleting this will move it to the trash, not delete it permanently.",
          icon: "warning",
          buttons: true,
          dangerMode: true,
        }).then((willDelete) => {
      ...
      $(".restore-confirm").click(function (event) {
        var form = $(this).closest("form");
        event.preventDefault();
        swal({
