                ...
                <div class="row">
                    <div class="col-sm-8">
                        <ul class="action2-btn">
                            ...
                            @php
                                $route = request()->is('delete-order') 
                                    ? route('admin.order.bulk_destroy') 
                                    : route('admin.order.bulk_soft_delete');
                            @endphp
                            
                            {{-- <li>
                                <a href="{{ $route }}" class="btn rounded-pill btn-danger order_delete">
                                    <i class="fe-plus"></i> Delete All
                                </a>
                            </li> --}}
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-list custom-btn-list">   
                                    ...
                                    @if ($order_status->name != 'Delete Order')
