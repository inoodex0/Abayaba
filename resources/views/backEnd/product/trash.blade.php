    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Product Trash Manage</h4>
            </div>
        </div>
    </div>       
    <!-- end page title --> 
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <ul class="action2-btn">
                            ...
                            <li><a href="{{route('products.retrieve')}}" class="btn rounded-pill btn-primary retrieve"><i class="fe-rotate-ccw"></i></i> Restore</a></li>
                            <li><a href="{{route('products.delete')}}" class=" btn  rounded-pill btn-danger delete"><i class="fe-trash-2"></i> Delete</a></li>
                        </ul>
                    </div>
                    <div class="col-sm-4">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-list custom-btn-list">
                                    ...
                                    <form method="post" action="{{route('products.restore')}}" class="d-inline">        
                                        @csrf
                                    <input type="hidden" value="{{$value->id}}" name="hidden_id">
                                    <button type="submit" class="restore-confirm" title="Restore"><i class="fe-rotate-ccw"></i></button></form>
                            ...
                            <td style="color: {{$value->stock > 0 ? '#000' : 'red'}};">{{$value->stock > 0 ? $value->stock : 'Out Of Stock'}}</td>
...
$(document).ready(function(){
    ...
    $(document).on('click', '.retrieve', function(e){
        ...
        swal({
          title: `Are you sure you want to restored?`,
          text: "",
          icon: "warning",
          buttons: true,
          dangerMode: true,
