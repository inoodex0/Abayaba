...
<div class="container-fluid">
  ...
  <div class="row justify-content-center">
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
          @include('backEnd.layouts.validation-errors')
          <form action="{{route('products.store')}}" method="POST" class="row" data-parsley-validate="" enctype="multipart/form-data">
            ...
            <div class="col-sm-6">
              <div class="form-group mb-3">
                ...
                <small id="nameCount" class="text-muted">0 characters</small>
                @error('name')
            ...
            <div class="col-sm-6">
              <div class="form-group mb-3">
                ...
                <input type="text" class="form-control @error('sku') is-invalid @enderror" name="sku" value="{{ old('sku') }}" id="sku" required="" />
                @error('sku')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="col-sm-4 mb-3">
              <div class="form-group mb-3">
                ...
                <input type="text" class="form-control @error('img_alt_text') is-invalid @enderror" name="img_alt_text" value="{{ old('img_alt_text') }}" id="img_alt_text" required="" />
                @error('img_alt_text')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="col-sm-12 mb-3">
              <div class="form-group">
                ...
                <textarea name="specification" id="specification" class="summernote form-control">{{ old('specification', $product->specification ?? '') }}</textarea>
              </div>
            </div>
            <!-- col end -->
            <!-- col start -->
            <div class="col-sm-12 mb-3">
              <div class="form-group">
                ...
                <small id="descriptionCount" class="text-muted">0 characters</small>
                @error('description')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
           ...
           <div class="col-sm-12 mb-3">
            <div class="form-group">
              ...
              <input type="text" name="tags" id="tags" class="form-control" placeholder="e.g. Electronics, Laptop, Sale">
...
<script>
  ...
  $('.summernote').on('summernote.change', function(we, contents, $editable) {
      let plainText = $('<div>').html(contents).text(); // Strip HTML
