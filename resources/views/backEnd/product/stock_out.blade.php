...
@section('title','Stock Out Products')
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Stock Out Products</h4>
            </div>
        </div>
    </div>       
    <!-- end page title --> 
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-list custom-btn-list">
                                    ...
                                    <form method="post" action="{{route('products.soft_delete')}}" class="d-inline">        
                                        @csrf
                                    <input type="hidden" value="{{$value->id}}" name="hidden_id">
                                    <button type="submit" class="soft-delete" title="Delete"><i class="fe-trash-2"></i></button></form>
                            ...
                            <td><img src="{{asset($value->image?$value->image->image:'')}}" class="backend-image" alt="{{ $value->img_alt_text }}"></td>
