                ...
                <form action="{{route('banners.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <!-- <div class="col-sm-12">
                        <div class="form-group mb-3">
                            <label for="link" class="form-label">Banner Text *</label>
                            <input type="text" class="form-control @error('banner_text') is-invalid @enderror" name="banner_text" value="{{$edit_data->banner_text}}" id="banner_text" required="">
                            @error('banner_text')
